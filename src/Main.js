    ...
    <div className='body-header'>
      ...
      <body class="mybody">
        ...
        <div class="main-banner">
          ...
          <img src="bx2.png" className='video'
        ...
        <div class="parent-valed-containerlis" >
          ...
          <ul class="list-tow list-product" >
            ...
            >
              ...
              <Link className='my-li content-five list-tow-my-li' to={`/e/${3}`}>
                <div className='parent-stars'>
                  {new Array(4).fill().map(() => (
                    <FontAwesomeIcon className='star' icon={faStar} />
                  ))}
            ...
            <Tilt
              ...
              gyroscope={true}
            >
              <Link className='my-li content-tow list-tow-my-li' to={`/e/${6}`}>
            ...
            >
              ...
              <Link className='my-li content-three list-tow-my-li' to={`/e/${4}`}>
